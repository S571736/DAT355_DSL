...
/**
 * This is the item provider adapter for a {@link timedStateMachine.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_target_feature",
								"_UI_Transition_type"),
						TimedStateMachinePackage.Literals.TRANSITION__TARGET, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_source_feature",
								"_UI_Transition_type"),
						TimedStateMachinePackage.Literals.TRANSITION__SOURCE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_condition_feature",
								"_UI_Transition_type"),
						TimedStateMachinePackage.Literals.TRANSITION__CONDITION, true, false, true, null, null, null));
	}
