...
public interface TimedStateMachinePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://my.custom.uri/timedStateMachine";
	 ...
	 * @ordered
	 */
	int STATE_MACHINE__CONDITIONS = NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRANSITION__CONDITION = NAMED_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link timedStateMachine.impl.ConditionImpl <em>Condition</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see timedStateMachine.impl.ConditionImpl
	 * @see timedStateMachine.impl.TimedStateMachinePackageImpl#getCondition()
	 * @generated
	 */
	int CONDITION = 5;
	 ...
	 * @ordered
	 */
	int CONDITION__TIMER = NAMED_ELEMENT_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link timedStateMachine.StateMachine#getConditions <em>Conditions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Conditions</em>'.
	 * @see timedStateMachine.StateMachine#getConditions()
	 * @see #getStateMachine()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link timedStateMachine.Transition#getCondition <em>Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Condition</em>'.
	 * @see timedStateMachine.Transition#getCondition()
	 * @see #getTransition()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link timedStateMachine.Condition <em>Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Condition</em>'.
	 * @see timedStateMachine.Condition
	 * @generated
	 */
	EClass getCondition();

	/**
	 * Returns the meta object for the containment reference '{@link timedStateMachine.Condition#getTimer <em>Timer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Timer</em>'.
	 * @see timedStateMachine.Condition#getTimer()
	 * @see #getCondition()
	 * @generated
	 */
	EReference getCondition_Timer();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link timedStateMachine.impl.ConditionImpl <em>Condition</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see timedStateMachine.impl.ConditionImpl
		 * @see timedStateMachine.impl.TimedStateMachinePackageImpl#getCondition()
		 ...
		 * @generated
		 */
		EReference CONDITION__TIMER = eINSTANCE.getCondition_Timer();
