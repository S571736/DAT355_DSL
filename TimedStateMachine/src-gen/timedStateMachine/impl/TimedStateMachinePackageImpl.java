 ...
 * @generated
 */
public class TimedStateMachinePackageImpl extends EPackageImpl implements TimedStateMachinePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see timedStateMachine.TimedStateMachinePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TimedStateMachinePackageImpl() {
		super(eNS_URI, TimedStateMachineFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link TimedStateMachinePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TimedStateMachinePackage init() {
		if (isInited)
			return (TimedStateMachinePackage) EPackage.Registry.INSTANCE.getEPackage(TimedStateMachinePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTimedStateMachinePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TimedStateMachinePackageImpl theTimedStateMachinePackage = registeredTimedStateMachinePackage instanceof TimedStateMachinePackageImpl
				? (TimedStateMachinePackageImpl) registeredTimedStateMachinePackage
				: new TimedStateMachinePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTimedStateMachinePackage.createPackageContents();

		// Initialize created meta-data
		theTimedStateMachinePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTimedStateMachinePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TimedStateMachinePackage.eNS_URI, theTimedStateMachinePackage);
		return theTimedStateMachinePackage;
	}
	 ...
	 * @generated
	 */
	public EReference getCondition_Timer() {
	 ...
	 * @generated
	 */
	public TimedStateMachineFactory getTimedStateMachineFactory() {
		return (TimedStateMachineFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(conditionEClass, CONDITION__TIMER);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getStateMachine_Conditions(), this.getCondition(), null, "conditions", null, 0, -1,
				StateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransition_Source(), this.getState(), this.getState_Outgoing(), "source", null, 1, 1,
				Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Condition(), this.getCondition(), null, "condition", null, 1, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(conditionEClass, Condition.class, "Condition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCondition_Timer(), this.getTimeEvent(), null, "timer", null, 1, 1, Condition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
