 ...
 * @generated
 */
public class TimedStateMachineSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TimedStateMachineSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TimedStateMachinePackage.NAMED_ELEMENT: {
		...
		case TimedStateMachinePackage.CONDITION: {
